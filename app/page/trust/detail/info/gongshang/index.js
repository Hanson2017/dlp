                    ...
                    data != null ?
                        <ScrollView contentContainerStyle={styles.GongshangBox}>
                            ...
                            <View style={styles.GongshangList}>
                                ...
                                <Text style={styles.text}>{data.chengliriqi !== ''?Util.formatDate2(data.chengliriqi):'--'}</Text>
                            </View>
                            <View style={styles.GongshangList}>
                            ...
                            <View style={styles.GongshangList}>
                                ...
                                <Text style={styles.text}>{data.fazhaoriqi !== ''?Util.formatDate2(data.fazhaoriqi):'--'}</Text>
                            </View>
                            <View style={styles.GongshangList}>
