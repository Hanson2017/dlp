...
import { Text, StyleSheet, View, TouchableOpacity, DeviceEventEmitter, Picker, Animated, Dimensions, Easing,DatePickerIOS } from 'react-native';
...
export default class Select extends Component {
    ...
    ok() {
        if (!this.state.hide) {
            this.outAnimated();
            DeviceEventEmitter.emit('selectDate', Util.setDate(this.state.date))
        }
    }
    show(selectNo) {
        if (this.state.hide) {
