...
module.exports = {
        ...
        return (
            <View style={stylesList.itemRow2} key={index} >
                ...
                >
                    ...
                    <View style={[stylesList.tdUp2, { width: Theme.screenWidth >= 375 ? (Theme.screenWidth - 150) * 0.38 : (Theme.screenWidth - 150) * 0.5 }]}>
    ...
    ListHeaderComponentR() {
        let listTitle = [
            { title: '综合流量', width: Theme.screenWidth >= 375 ? (Theme.screenWidth - 150) * 0.38 : (Theme.screenWidth - 150) * 0.5 },
            { title: '关键字' },
        ]
        return (
