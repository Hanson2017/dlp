    ...
    render() {
        ...
        return (
            <View style={Theme.container}>
                <Header headerOpt={{ title: params.platName, isflmf: dataInfo.isflmf, fund: dataInfo.fundtype }} navigation={navigation} showActionSheet={this.showActionSheet.bind(this)} />
