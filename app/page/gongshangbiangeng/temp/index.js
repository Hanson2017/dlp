        ...
        return (
            <View style={[stylesList.itemRow,styles.itemRow]} key={index}>
                ...
                >
                    ...
                    <Text style={[stylesList.C2D3640, stylesList.dateTime]}>{item.type}</Text>
                    <Text style={[stylesList.C2D3640, stylesList.dateTime]}>{Util.formatDate2(item.updatetime)}</Text>
    ...
    ListHeaderComponentR() {
        return (
            <View style={stylesList.headerRow}>
                <Text style={[stylesList.tdName_black, stylesList.headerRowText]}></Text>
                <Text style={[stylesList.dateTime, stylesList.headerRowText]}>变更项目</Text>
                <Text style={[stylesList.dateTime, stylesList.headerRowText]}>变更日期</Text>
